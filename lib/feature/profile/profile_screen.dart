          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Rich Andienty', style: Poppins.bold(22, color: Colors.white),),
              ...
              Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text('About Us', style: Poppins.bold(14),)
                        ],
                      ),
                    )
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text('FAQ', style: Poppins.bold(14),)
                        ],
                      ),
                    )
                    ),
                ...
                Container(
                  ...
                  child: InkWell(
                    ...
                    splashColor: Colors.grey.withOpacity(0.7),
                    child: Center(
                      child: Text('Log out', style: Poppins.bold(14, color: Colors.white),),
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: Align(
                    ...
                    child: Text('Lingkar Budaya Version 1.0', style: Poppins.medium(14, color: Colors.white),),
                  )
                ),
